        ...
        pub mod monotonic_clock {
            ...
            pub fn now() -> Instant {
                unsafe {
                    ...
                    #[link(wasm_import_module = "wasi:clocks/monotonic-clock@0.2.10")]
                    unsafe extern "C" {
                        #[link_name = "now"]
                        fn wit_import0() -> i64;
                    }
        ...
        pub mod types {
            ...
            unsafe impl _rt::WasmResource for Fields {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:http/types@0.2.10")]
                        unsafe extern "C" {
        ...
        pub mod poll {
            ...
            unsafe impl _rt::WasmResource for Pollable {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:io/poll@0.2.10")]
                        unsafe extern "C" {
        ...
        pub mod error {
            ...
            unsafe impl _rt::WasmResource for Error {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:io/error@0.2.10")]
                        unsafe extern "C" {
        ...
        pub mod streams {
            ...
            unsafe impl _rt::WasmResource for InputStream {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:io/streams@0.2.10")]
                        unsafe extern "C" {
    ...
    pub mod wasi {
        pub mod http {
            ...
            pub mod incoming_handler {
                ...
                #[doc(hidden)]
                macro_rules! __export_wasi_http_incoming_handler_0_2_10_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "wasi:http/incoming-handler@0.2.10#handle")] unsafe extern "C" fn
                ...
                #[doc(hidden)]
                pub(crate) use __export_wasi_http_incoming_handler_0_2_10_cabi;
            }
        }
    }
}
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_wasi_example_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasi::http::incoming_handler::__export_wasi_http_incoming_handler_0_2_10_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wasi::http::incoming_handler);
    };
}
#[doc(inline)]
pub(crate) use __export_wasi_example_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:nexus:core@0.1.0:wasi-example:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6355] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xd00\x01A\x02\x01A\x13\
...
\0\x13wasi:io/poll@0.2.10\x05\0\x02\x03\0\0\x08pollable\x01B\x0f\x02\x03\x02\x01\
...
ks/monotonic-clock@0.2.10\x05\x02\x01B\x04\x04\0\x05error\x03\x01\x01h\0\x01@\x01\
\x04self\x01\0s\x04\0\x1d[method]error.to-debug-string\x01\x02\x03\0\x14wasi:io/\
error@0.2.10\x05\x03\x02\x03\0\x02\x05error\x01B(\x02\x03\x02\x01\x04\x04\0\x05e\
rror\x03\0\0\x02\x03\x02\x01\x01\x04\0\x08pollable\x03\0\x02\x01i\x01\x01q\x02\x15\
...
m.splice\x01\x18\x04\0%[method]output-stream.blocking-splice\x01\x18\x03\0\x16wa\
si:io/streams@0.2.10\x05\x05\x02\x03\0\x01\x08duration\x02\x03\0\x03\x0cinput-st\
ream\x02\x03\0\x03\x0doutput-stream\x01B\xc1\x01\x02\x03\x02\x01\x06\x04\0\x08du\
ration\x03\0\0\x02\x03\x02\x01\x07\x04\0\x0cinput-stream\x03\0\x02\x02\x03\x02\x01\
...
\0\x8c\x01\x04\0\x0fhttp-error-code\x01\x8d\x01\x03\0\x16wasi:http/types@0.2.10\x05\
\x09\x02\x03\0\x04\x10incoming-request\x02\x03\0\x04\x11response-outparam\x01B\x08\
\x02\x03\x02\x01\x0a\x04\0\x10incoming-request\x03\0\0\x02\x03\x02\x01\x0b\x04\0\
\x11response-outparam\x03\0\x02\x01i\x01\x01i\x03\x01@\x02\x07request\x04\x0cres\
ponse-out\x05\x01\0\x04\0\x06handle\x01\x06\x04\0!wasi:http/incoming-handler@0.2\
.10\x05\x0c\x04\0\x1bnexus:core/wasi-example@0.1.0\x04\0\x0b\x12\x01\0\x0cwasi-exa\
